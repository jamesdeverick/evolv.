...
class ContentBriefCreator:
    ...
    def create_brief(
        ...
        prompt_lines = [
            ...
            "",
            "**LLM's Previous Audit Analysis (CRITICAL - USE THIS STRUCTURE):**",
            llm_analysis or "[No previous LLM analysis available]",
            "",
            "IMPORTANT: The analysis above contains a well-structured content outline with proper H2 (##) and H3 (###) headings.",
            "You MUST use this exact same heading structure and format in your content brief below.",
            "Copy the heading hierarchy and markdown syntax from the analysis above.",
            "",
            "**Key SERP Insights:**",
